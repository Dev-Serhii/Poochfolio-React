...
export const ReservationsPage: React.FC<Props> = () => {
    ...
    const approved = useSelector((state: any) => state.data.approved);
            ...
            >
                ...
                <styled.ModalContent>
                    <styled.ModalClose onClick={() => {
                        ...
                        <AiOutlineClose size={28} color={COLOR.primary0} />
                    </styled.ModalClose>
                    <styled.ModalBody>
                        <styled.ModalTitle>Thank you for submitting your listing</styled.ModalTitle>
                        <styled.ModalDescription>We are currently reviewing it to ensure it meets our advertising guidelines. Once the review process is completed, we will notify you.</styled.ModalDescription>
                        <styled.Logout onClick={onLogout}>Logout</styled.Logout>
                    </styled.ModalBody>
                    <styled.ModalFooter>
                        <label>Poochfolio®</label>
                    </styled.ModalFooter>
                </styled.ModalContent>
            </Modal>
            <styled.Dashboard>
