...
import googleMap from "../../../../../assets/images/brands/google-maps.svg"
...
export const PoweredBy: React.FC<Props> = () => {
    ...
    const topRow = windowSize.innerWidth < 1050 ? [twilio, aws, intuit, googleMap, elastic] : [twilio, stripe, aws, docuSign, intuit, paypal]
    const bottomRow = windowSize.innerWidth < 1050 ? [stripe, docuSign, paypal, muleSoft, cometchat] : [googleMap, muleSoft, elastic, cometchat]
