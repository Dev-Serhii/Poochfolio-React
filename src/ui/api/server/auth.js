...
export const subscribe = (dispatch, data) => new Promise(async (resolve, reject) => {
    dispatch({
        type: SET_LOADING,
        payload: true
    })
    try {
        HTTPS.post('/groomers/subscribe', data)
        .then((response) => {
            dispatch({
                type: SET_LOADING,
                payload: false
...
export const scheduleDemo = (dispatch, data) => new Promise(async (resolve, reject) => {
    dispatch({
        type: SET_LOADING,
        payload: true
    })
    try {
        HTTPS.post('/demos/schedule', data)
        .then((response) => {
            dispatch({
                type: SET_LOADING,
                payload: false
